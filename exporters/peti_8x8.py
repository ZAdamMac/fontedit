...
##
## Simple exporter for Peti's TextPrintSmall font (font8x8).
##
...
exporters = {"name": "PETI Small Font Exporter",
             "desc": "Matches the 8x8 Font for PETI",
             "func": export}
